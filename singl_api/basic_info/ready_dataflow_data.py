...
def get_dataflow_data(flow_name):
    ...
    try:
        ...
        if "auto_api_test" == flow_name:
            ...
            return data
        elif "gjb_workflow" == flow_name:
            data = {"needApproval":1,"name":flow_info[0]["name"]+data_now(),"flowId":flow_info[0]["id"],"flowName":flow_info[0]["name"],"flowType":flow_info[0]["flow_type"],"flowVersion":flow_info[0]["version"],"schedulerId":"once","source":"rhinos","configurations":{"event":{"sourceId":"","type":"","datasetId":""},"mqConfig":{"nameServer":"","topic":"","groupId":"","subExpression":"*"},"startTime":get_now(),"endTime":None,"arguments":[{"name":"var","value":"helloworld1","_uuid_":"dynamic_1"},{"name":"vars","value":"remote","_uuid_":"dynamic_2"}],"extraConfigurations":{},"extraConfigurationsArray":[],"dependencies":[],"cron":"","schedulingMode":"TimingSchedulingMode","properties":[{"name":"all.debug","value":"false"},{"name":"all.debug-rows","value":20},{"name":"all.dataset-nullable","value":"false"},{"name":"all.optimized-enable","value":"true"},{"name":"all.output-notify","value":"true"},{"name":"all.cluster-id","value":"cluster1"},{"name":"dataflow.queue","value":"root.default"},{"name":"dataflow.verbose","value":"true"},{"name":"dataflow.master","value":"yarn"},{"name":"dataflow.deploy-mode","value":"cluster"},{"name":"dataflow.num-executors","value":2},{"name":"dataflow.driver-memory","value":"1G"},{"name":"dataflow.executor-memory","value":"2G"},{"name":"dataflow.executor-cores","value":2},{"name":"dataflow.local-dirs","value":""},{"name":"dataflow.temp-dir","value":"/tmp/dataflow/spark"},{"name":"dataflow.sink-concat-files","value":"true"},{"name":"spark.queue","value":"root.default"},{"name":"spark.verbose","value":"true"},{"name":"spark.master","value":"yarn"},{"name":"spark.deploy-mode","value":"cluster"},{"name":"spark.num-executors","value":2},{"name":"spark.driver-memory","value":"1G"},{"name":"spark.executor-memory","value":"2G"},{"name":"spark.executor-cores","value":2},{"name":"spark.local-dirs","value":""}],"retry":{"enable":False,"limit":1,"timeInterval":1,"intervalUnit":"MINUTES"}}}
            return data
        else:
            return
