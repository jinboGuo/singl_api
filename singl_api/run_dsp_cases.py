...
from basic_info.setting import dsp_host, dsp_sheet, receivers_test, receivers_list, log, begin_times
...
if __name__ == '__main__':
    ...
    """发送邮件"""
    baymax_main(dsp_host, receivers_test, dsp_sheet, begin_times,total_time)