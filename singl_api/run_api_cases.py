...
from basic_info.setting import host, baymax_sheet, receivers_test, receivers_list, log, begin_times
...
if __name__ == '__main__':
    ...
    result.report(filename='api_result', description=host, report_dir='Reports',theme='theme_cyan')
    ...
    """发送邮件"""
    baymax_main(host, receivers_test, baymax_sheet, begin_times,total_time)