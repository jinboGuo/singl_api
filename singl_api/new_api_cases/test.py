...
def test_secret_key():
    ...
    header = {'hosts': '127.0.0.1', 'Content-Type': 'application/json', "Authorization": "Bearer 5064ad52-c06e-4d2f-8996-585b4c1151f0", "Accept": "application/json"}
...
def test_pull():
    ...
    #header = {'hosts': '127.0.0.1','Content-Type': 'application/json', "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..BC1KkBcKBIyiBU2zReVUQaYmowMeMu1MRrhQTsyWySofVa4r3qATPOqGUAP3xCFJpuw6WKl3vkYMiEHOlsIHY3c1CQAzyq-ne1x-ZsMrQCYMBu9rhL5WdMUVWq-2UFwpYVWlBpX-gLUr6auMdqQCSd0YpH87TdjykKjLcW73mT908tmwipIaP742jKYxhOOyaZeuq42AtI_F8BpOIbmL6BXY9aeB9eMCo1biGxBxja2YXeR3qC3j6DPyfjfPfBCfYcHBSduzAPCcRVtwQL0KGfVHYG75kDeyR_7OoiG0jYTXRiVBGXtiXD6ZvY1yMOaPObbJEBKkXo_eH0Dp4yaZcA", "Accept": "application/json"}
    #body = {"dataServiceId": "700735577841991680", "accessKey": "1bb2f62d-25e2-470c-b802-4b289b847e1a", "offset": 0, "size": 10000}
    header = {'hosts': '192.168.2.142', 'Content-Type': 'application/json', "Authorization": "Bearer 5064ad52-c06e-4d2f-8996-585b4c1151f0", "Accept": "application/json"}
    body = {"dataServiceId": "715969255308263424", "accessKey": "5d577396-2f67-483c-90ab-a4e94932ecd1", "encrypted":"false","offset": 0, "size": 100}
