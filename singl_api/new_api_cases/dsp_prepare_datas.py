...
def pull_data(data):
    ...
    if 'snow_dataset_dsp' in data:
        ...
        new_data = {"sourceType": "DATASOURCE","accessKey": "5d577396-2f67-483c-90ab-a4e94932ecd1", "severName":"api_datasource","dataServiceId": flow_info[0]["id"],"encrypted":"false","query":{"pageable":{"pageNum":1,"pageSize":10,"pageable":"true"},"parameters":[{"name":"age","value":"18","defaultValue":"","content":""}],"sqlTemplate":""},"timestamp":1601014752}
        return new_data
    else:
        return
