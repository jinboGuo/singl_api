...
def pull_data(data):
    ...
    try:
        ...
        flow_info = ms.ExecuQuery(sql.encode('utf-8'))
        print('service_id-name:', flow_info[0]["id"], flow_info[0]["name"])
    except:
        return
    if 'snow_dataset_dsp' in data:
        ...
        new_data = {"sourceType": "DATASOURCE","accessKey": "5d577396-2f67-483c-90ab-a4e94932ecd1", "severName":flow_info[0]["name"], "dataServiceId": flow_info[0]["id"], "encrypted":"false","query":{"pageable":{"pageNum":1,"pageSize":10,"pageable":"true"},"parameters":[{"name":"age","value":"18","defaultValue":"","content":""}],"sqlTemplate":""},"timestamp":1601014752}
        return new_data
    elif 'api_mysqldataset' in data:
        new_data = {"sourceType": "DATASET", "accessKey": "5d577396-2f67-483c-90ab-a4e94932ecd1", "severName": flow_info[0]["name"], "dataServiceId": flow_info[0]["id"], "encrypted": "false", "query":{"fieldGroup":{"fields":[{"andOr":"AND","name":"id","oper":"NOT_EQUAL","value":["11"]}],"fieldGroups":[]},"ordSort":[{"name":"id","order":"ASC"}],"pageable":{"pageSize":10,"pageNum":1},"selectProperties":["id","user_id","number","createtime","note","dt"]},"timestamp":1602677876}
        return new_data
    else:
        return
