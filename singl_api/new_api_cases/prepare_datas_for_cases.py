...
def upddss_data(data):
    try:
        data=data.split("&")
        sql = "select id,owner,name,tenant_id,resource_id from merce_dss where name like '%s%%%%' ORDER BY create_time limit 1" % data[0]
    ...
    if 'gjb_api_for_all_type_JDBC_datasource_test' in data:
        ...
        new_data = {"tenantId":dss_info[0]["tenant_id"],"owner":dss_info[0]["owner"],"name":dss_info[0]["name"],"enabled":1,"creator":"admin","createTime":"2022-04-19 16:02:09","lastModifier":"admin","lastModifiedTime":"2022-04-19 16:18:31","id":dss_id,"version":2,"groupCount":None,"groupFieldValue":None,"tableName":data[1],"type":"DB","path":None,"attributes":{"schema":"","jarPath":"mysql-connector-java-5.1.46.jar","catalog":"","DBType":"Mysql","batchsize":10000,"paraSep":"&","url":"jdbc:mysql://192.168.1.82:3306/merce_62","database":"merce_62","password":"a$cad2fb721d282f6e5151605a1874ffe4~","driver":"com.mysql.jdbc.Driver","port":3306,"name":"Mysql_5","host":"192.168.1.82","paraPrefix":"?","user":"merce","defaultUrl":"jdbc:mysql://[HOST]:[PORT]/[DB]","properties":[],"dateToTimestamp":"false"},"resource":None,"resourceId":dss_info[0]["resource_id"],"tags":[],"description":"","expiredPeriod":0}
        return dss_id, new_data
    else:
       return
resource_id,tenant_id,owner=None,None,None
...
def dataset_data(data):
    ...
    if 'gjb_test_ftp_dataset' in data:
        ...
        dataset_id, dataset_name,resource_id = get_dataset_data(data)
        new_data = {"id":dataset_id,"name":dataset_name,"description":"","resource":None,"schema":{"tenantId":tenant_id,"owner":owner,"name":schema_name,"enabled":1,"creator":"admin","createTime":"2022-04-20 10:12:28","lastModifier":"admin","lastModifiedTime":"2022-04-20 10:13:09","id":schema_id,"version":1,"groupCount":None,"groupFieldValue":None,"resourceId":schema_resourceid,"fields":[{"name":"id","type":"int","alias":"","description":"","fieldCategory":None,"specId":None},{"name":"ts","type":"timestamp","alias":"","description":"","fieldCategory":None,"specId":None},{"name":"code","type":"string","alias":"","description":"","fieldCategory":None,"specId":None},{"name":"total","type":"float","alias":"","description":"","fieldCategory":None,"specId":None},{"name":"forward_total","type":"float","alias":"","description":"","fieldCategory":None,"specId":None},{"name":"reverse_total","type":"float","alias":"","description":"","fieldCategory":None,"specId":None},{"name":"sum_flow","type":"float","alias":"","description":"","fieldCategory":None,"specId":None}],"primaryKeys":None,"resource":None,"oid":schema_id,"newest":0,"isHide":0,"tags":[],"description":"gjb_ttest_mysql0420_training","expiredPeriod":0},"storage":"HDFS","expiredPeriod":0,"tags":[],"storageConfigurations":{"flatten":"true","expiredTime":0,"time":"s","format":"csv","path":"/auto_test/api","relativePath":"/home/auto_test/gjb/out8","pathMode":"exact","header":"false","ignoreRow":"0","separator":",","quoteChar":"\"","escapeChar":"\\","encryptKey":"","encryptColumnsTemplate":[],"encryptColumns":"","hdfsPartitionColumn":"","specialFieldSelect":"","partitionType":"DateFormat","dateFormat":"","dateFrom":"","dateTo":"","cycle":"","datePeriod":"","dateUnit":"HOUR","clusterId":"cluster1","partitionList":"","pathFilter":"(.inprogress|.pending)","csv":"csv"},"sliceTime":"","sliceType":"H","owner":owner,"schemaVersion":1,"timestampAsOf":"","specialField":{"name":None,"type":None,"alias":None,"description":None,"currVal":None},"tenantId":tenant_id,"enabled":1,"creator":"admin","createTime":"2020-04-22 18:25:05","lastModifier":"admin","lastModifiedTime":"2022-04-20 14:33:51","version":5,"groupCount":None,"groupFieldValue":None,"alias":None,"resourceId":resource_id,"schemaId":schema_id,"source":None,"recordNumber":0,"byteSize":0,"type":"NORMAL","analysisTime":0,"formatConfigurations":None,"isRelated":1,"isHide":0}
...
def get_old_id_name(data):
    try:
        ...
        return
    new_data={"configurations":{"startTime":"当前时间戳","arguments":[],"dependencies":[],"extraConfigurations":{},"properties":[{"name":"all.debug","value":"false","input":"false"},{"name":"all.dataset-nullable","value":"false","input":"false"},{"name":"all.optimized.enable","value":"true","input":"true"},{"name":"all.lineage.enable","value":"false","input":"false"},{"name":"all.debug-rows","value":"20","input":"20"},{"name":"all.runtime.cluster-id","value":"cluster1","input":["cluster1"]},{"name":"dataflow.master","value":"yarn","input":"yarn"},{"name":"dataflow.deploy-mode","value":"cluster","input":["client","cluster"]},{"name":"dataflow.queue","value":"default","input":["default"]},{"name":"dataflow.num-executors","value":"2","input":"2"},{"name":"dataflow.driver-memory","value":"512M","input":"512M"},{"name":"dataflow.executor-memory","value":"1G","input":"1G"},{"name":"dataflow.executor-cores","value":"2","input":"2"},{"name":"dataflow.verbose","value":"true","input":"true"},{"name":"dataflow.local-dirs","value":"","input":""},{"name":"dataflow.sink.concat-files","value":"true","input":"true"},{"name":"dataflow.tempDirectory","value":"/tmp/dataflow/spark","input":"/tmp/dataflow/spark"}],"retry":{"enable":False,"limit":1,"timeInterval":1,"intervalUnit":"MINUTES"}},"schedulerId":"once","ource":"rhinos","version":0,"flowId":flow_id,"flowType":"dataflow","name":data+"_随机数","creator":"admin","oldName":old_name}
