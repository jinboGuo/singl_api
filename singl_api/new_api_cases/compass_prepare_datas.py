...
def get_jobview_exec(data):
    try:
        ...
        if data =='gjb_scheduler&all':
            ...
            return new_data
        elif data =='gjb_scheduler&jobtype4':
